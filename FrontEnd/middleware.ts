...
export const config = {
  ...
  matcher: [
    '/((?!_next/static|_next/image|favicon.ico|robots\\.txt|sitemap\\.xml|feeds/.*|llms\\.txt|manifest\\.json|uploads/.*|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|txt|xml|json)$|api|auth|health).*)',
  ],
};
